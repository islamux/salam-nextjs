...
/**
 * Transform Chapter 20 from Dart source to JSON
...
const dartFilePath = path.join(__dirname, 'texts-original/text/elm_text_ders_twenty.dart');
...
// Write to file
const outputPath = path.join(__dirname, 'public/khwater/20.json');
fs.writeFileSync(outputPath, JSON.stringify(jsonData, null, 2), 'utf8');

console.log('✅ Chapter 20 transformation complete!');
...
console.log(`   Expected Titles: 19 (Got: ${titleCount})`);
console.log(`   Expected Subtitles: 14 (Got: ${subtitleCount})`);
console.log(`   Expected Texts: 79 (Got: ${textCount})`);
console.log(`   Expected Ayahs: 63 (Got: ${ayahCount})`);
console.log(`   Expected Total: 175 (Got: ${items.length})`);

if (items.length === 175 && titleCount === 19) {
