 ...
 * FIXES: Captures ALL 14 titles (was missing 12 titles)
 */
...
for (let i = 0; i < lines.length; i++) {
  ...
  // Match titles, texts, ayahs, subtitles, footers
...
console.log(`   Expected Titles: 14 (Got: ${titleCount})`);
console.log(`   Expected Subtitles: 12 (Got: ${subtitleCount})`);
console.log(`   Expected Texts: 67 (Got: ${textCount})`);
console.log(`   Expected Ayahs: 62 (Got: ${ayahCount})`);
console.log(`   Expected Total: 155 (Got: ${items.length})`);

if (items.length === 155 && titleCount === 14) {
