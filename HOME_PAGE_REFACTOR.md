...
This plan outlines the steps to refactor the `HomePage` component in `src/app/(routes)/home/page.tsx` into smaller, more manageable components.

## 1. Create New Directory

Create a new directory to house the components for the home page:
...
This component will contain the main heading and search link.
...
## 3. Create ChapterCard Component

This component will display a single chapter in the grid.

**File:** `src/components/home/ChapterCard.tsx`

```tsx
import Link from 'next/link';
import { translations } from '@/lib/translations';
import type { Chapter } from '@/lib/types/khwater';
...
## 4. Create ChapterGrid Component

This component will display the grid of chapters.

**File:** `src/components/home/ChapterGrid.tsx`
...
Finally, update the `HomePage` to use these new components.

**File:** `src/app/(routes)/home/page.tsx`
