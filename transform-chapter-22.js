...
/**
 * Transform Chapter 22 from Dart source to JSON
...
const dartFilePath = path.join(__dirname, 'texts-original/text/elm_text_ders_twenty_two.dart');
...
// Write to file
const outputPath = path.join(__dirname, 'public/khwater/22.json');
fs.writeFileSync(outputPath, JSON.stringify(jsonData, null, 2), 'utf8');

console.log('✅ Chapter 22 transformation complete!');
